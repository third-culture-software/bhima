...
const { totalPeriods } = require('../../../server/controllers/finance/reports/cashflow/cashflow.function');
...
describe('totalPeriods', () => {
  it('should calculate the total for each period based on income, expense, and transfer totals', () => {
    ...
    const result = totalPeriods(data, incomeTotal, expenseTotal, transferTotal);
