  ...
  it('POST /multiple_payroll/:id/ Payroll Management: Continuity of Work For Employees Amelia Rose Thornton', () => {
    return agent.post('/multiple_payroll/'.concat(params.periodPaie, '/configuration'))
      ...
      .then((res) => {
        ...
        expect(res.body.rubrics[2].total).to.equal(330.75);
        ...
        expect(res.body.rubrics[8].total).to.equal(22.08);

        // Housing Benefit (30% of base)
        // 225 × 0.3 = $67.5
        expect(res.body.rubrics[5].total).to.equal(67.50);
         ...
         */
        expect(res.body.rubrics[9].total).to.equal(122.33);
  ...
  it('POST /multiple_payroll/:id/configuration should Set Configuration of Paiement for Multiple Patient', () => {
    return agent.post('/multiple_payroll/'.concat(params.periodPaie, '/multiConfiguration'))
      ...
      .then((res) => {
        ...
        // 220 × 35 × 0.035 = $269.50
        expect(res.body.dataEmployees[0].rubricTaxable[2].result_equiv).to.equal(269.5);

        // Housing Benefit (30% of base)
        // 220 × 0.3 = $66.00
        expect(res.body.dataEmployees[0].rubricNonTaxable[1].result_equiv).to.equal(66);
        ...
        expect(res.body.dataEmployees[0].rubricDiscount[1].result_equiv).to.equal(17.13);
        ...
        expect(res.body.dataEmployees[0].rubricDiscount[4].result_equiv).to.equal(82.96);
        ...
        expect(res.body.dataEmployees[1].rubricTaxable[2].result_equiv).to.equal(2.88);

        // #### Housing Allowance (30%)
        // - $27.39 × 0.3 = $8.22
        expect(res.body.dataEmployees[1].rubricNonTaxable[1].result_equiv).to.equal(8.22);

        // #### High Cost of Living Indemnity
        // - $5.00
        expect(res.body.dataEmployees[1].rubricTaxable[1].result_equiv).to.equal(5);
        ...
        // - INSS QPO 3.5% = $1.23
        expect(res.body.dataEmployees[1].rubricDiscount[1].result_equiv).to.equal(1.23);
        ...
        expect(res.body.dataEmployees[1].rubricDiscount[4].result_equiv).to.equal(0);
