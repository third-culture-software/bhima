...
describe(`Tests verifies the generation, recording, and integrity of payroll commitments in BHIMA,
  ...
  it(`POST /multiple_payroll/:id/multiConfiguration for Employees Paiement`, async () => {
  ...
  */
  it(`POST /multiple_payroll/:id/commitment should Set Configuration of Payement with default option`, async () => {
