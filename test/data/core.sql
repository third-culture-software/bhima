...
SELECT
    unit.id,
    @superUser
FROM unit ON DUPLICATE KEY UPDATE unit_id = unit_id, user_id = user_id;
...
-- Action role
INSERT INTO role_actions SELECT
    HUID(UUID()) AS uuid,
    @roleUUID,
    id
FROM actions;
...
CALL CREATEFISCALYEAR(1, @fiscalYear2025, @superUser, 'Fiscal Year 2026', 12, DATE('2026-01-01'), DATE('2026-12-31'), 'Notes for 2026', @fiscalYear2026);
...
(1, HUID('4de0fe47-177f-4d30-b95f-cff8166400b4'), 'Church Employees', 174, HUID('1f162a10-9f67-4788-9eff-c1fea42fcc9b'), NULL, '', NULL, 0, 10, 0, NULL, 1, 1, 1, '#ff0000', 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP),
...
(
    HUID('274c51ae-efcc-4238-98c6-f402bfb39866'),
    1,
    2,
    HUID('3be232f9-a4b9-4af6-984c-5d3f87d5c107'),
    'Test 2 Patient',
    '1990-06-01 00:00:00',
    FALSE,
    NULL,
    ...
    NULL,
    NULL,
    HUID('1f162a10-9f67-4788-9eff-c1fea42fcc9b'),
    HUID('1f162a10-9f67-4788-9eff-c1fea42fcc9b'),
    (NOW() - INTERVAL 1 HOUR),
    NULL,
    NULL,
...
(
    HUID('81af634f-321a-40de-bc6f-ceb1167a9f65'),
    1,
    1,
    HUID('a11e6b7f-fbbb-432e-ac2a-5312a66dccf4'),
    'Test 1 Patient',
    '1990-06-01 00:00:00',
    FALSE,
    NULL,
...
(
    HUID('d1d7f856-d414-4400-8b94-8ba9445a2bc0'),
    1,
    4,
    HUID('76976710-27eb-46dd-b3f5-cb5eb4abbc92'),
    'Employee Test 1',
    '1960-06-30',
    0,
    NULL,
...
(
    HUID('0f2ddc0e-686b-47c0-ad80-989671aa9f1f'),
    1,
    5,
    HUID('dfbe4cd4-40fd-401f-bc7b-d4325119cb72'),
    'Bad Patient Doublon',
    '2017-08-24 00:00:00',
    FALSE,
    NULL,
