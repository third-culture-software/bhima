...
/**
  ...
  */
UPDATE report SET title_key = 'REPORT.STOCK_MOVEMENT_REPORT.TITLE'
WHERE report_key = 'stock_movement_report';
 ...
 */
UPDATE stock_setting SET average_consumption_algo = 'algo_msh'
WHERE average_consumption_algo NOT IN ('algo_1', 'algo_msh');
