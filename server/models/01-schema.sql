...
CREATE TABLE `general_ledger` (
  ...
  INDEX gl_entity_record (entity_uuid, record_uuid),
  INDEX gl_entity_entity_reference (entity_uuid, reference_uuid),
...
CREATE TABLE `posting_journal` (
  ...
  INDEX `account_id` (`account_id`),
  INDEX `trans_id_reference_number` (`trans_id_reference_number`),
  INDEX pj_entity_record (entity_uuid, record_uuid),
  INDEX pj_entity_entity_reference (entity_uuid, reference_uuid),
