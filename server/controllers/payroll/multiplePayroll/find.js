...
function find(options) {
  ...
  const sql = `
    SELECT BUID(payroll.employee_uuid) AS employee_uuid, payroll.reference, payroll.code, payroll.hiring_date,
      payroll.nb_enfant, payroll.individual_salary, payroll.account_id, payroll.creditor_uuid, payroll.function_name,
      payroll.display_name, payroll.sex, payroll.payment_uuid, payroll.payroll_configuration_id, payroll.currency_id,
